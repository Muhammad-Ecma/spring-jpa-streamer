...
-- Department
insert into department(name, organization_id) values('Admin department', 1);
insert into department(name, organization_id) values('Academic department', 1);
insert into department(name, organization_id) values('HR department', 2);
insert into department(name, organization_id) values('Dev Department', 2);
-- Employee
...
insert into employee(name, position, salary, age, department_id, organization_id) values ('Test10', 'Tester', 11000, 40, 1, 3, 2);
